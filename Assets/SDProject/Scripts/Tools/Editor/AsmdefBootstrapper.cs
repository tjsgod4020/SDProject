...
namespace SD.Tools.Editor
{
    internal static class AsmdefBootstrapper
    {
        ...
        private static string DetectProjectRoot()
        {
            ...
            throw new InvalidOperationException("������Ʈ ��Ʈ�� ã�� �� �����ϴ�. 'Assets/SDProject' �Ǵ� 'Assets/_Project' �� �ϳ��� �����ϰų�, ��ũ��Ʈ�� 'Assets/<Root>/Scripts/.../AsmdefBootstrapper.cs'�� �μ���.");
        }
        ...
        {
            public string Name;
            public string RelFolder;              // ��Ʈ(base)/ ���� ��� ��� ("Scripts/Core/Domain" ��)
        ...
        // ====== ���� ��� ======
        // ����: ������ "��Ʈ/RelFolder"�� ������. ��Ʈ�� DetectProjectRoot()�� �ڵ� ����.
        ...
        public static void CreateAsmdefs()
        {
            ...
            try
            {
                ...
                foreach (var spec in _specs)
                {
                    ...
                    {
                        // OverwriteExisting이 true이므로 항상 덮어쓰기
        ...
        private static void EnsureFolder(string folderPath)
        {
            ...
            if (parts.Length == 0 || parts[0] != "Assets")
                throw new InvalidOperationException($"��δ� 'Assets/..'�� �����ؾ� �մϴ�: {folderPath}");
